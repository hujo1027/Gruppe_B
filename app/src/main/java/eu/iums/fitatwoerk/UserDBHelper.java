...
public class UserDBHelper extends SQLiteOpenHelper {
    ...
    private String CREATE_USER_TABLE = "CREATE TABLE " + TABLE_USER + "("
            + COLUMN_USER_ID + " INTEGER PRIMARY KEY AUTOINCREMENT," + COLUMN_USER_NICKNAME + " TEXT,"
    ...
    public List<User> getAllUser() {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                user.setNickname(cursor.getString(cursor.getColumnIndexOrThrow(COLUMN_USER_NICKNAME)));
    ...
    //Überprüfen, ob User existiert anhand von Nickname
    ...
    //Überprüfen, ob User existiert anhand von Nickname und Passwort
    public boolean checkUser(String nickname, String password) {
        ...
        SQLiteDatabase db = this.getReadableDatabase();
        // selection criteria
        String selection = COLUMN_USER_NICKNAME + " = ?" + " AND " + COLUMN_USER_PASSWORD + " = ?";
        // selection arguments
